	...
	<header class="py-1 border-bottom">
		<div class="container d-flex flex-wrap justify-content-center">
			<ul class="nav me-auto">
	        	...
	        	<li class="nav-item"><a href="${contextPath}/marketBoardList.ma" class="nav-link link-dark px-2">싱글벙글</a></li>
	        	<li class="nav-item"><a href="#" class="nav-link link-dark px-2">씽씽마켓</a></li>
