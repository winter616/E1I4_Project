...
<style>
	...
	tr{font-size:20px;}
	.reviewContent{max-width:"1500px"}
...
<body>
		...
		<div class="container-fluid">
			<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
				<div class="navbar-nav">
					<span class="nav-link active" aria-current="page" href="#">내가 작성한 리뷰</span> 
					<span class="nav-link" href="#">작성 가능한 리뷰</span>
				</div>
			</div>
		</div>
	</nav>
	<section>
		...
		<div class="orderCancelProduct done">
			<span>주문번호 : 000-1111-123456</span>&nbsp;&nbsp;&nbsp;
			<span>주문일자 : 2022-02-12</span>&nbsp;&nbsp;&nbsp;
			<button type="button" class="btn btn-light" style="background:#008cd4; color:white; float:right" data-bs-toggle="modal" data-bs-target="#orderRatingModal">리뷰작성</button>
			<table class="table">
			    <tr>
			      <td scope="row" colspan="4"></td>
			    </tr>
